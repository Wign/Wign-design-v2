 ...
 * Generated for Laravel 6.0.3 on 2019-09-29 11:15:32.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class DB {
        ...
        /**
         * Get a Schemas builder instance for the connection.
         *
        ...
        /**
         * Set the Schemas grammar to the default implementation.
         *
         * @return void
         * @static
         */
        ...
        /**
         * Get the Doctrine DBAL Schemas manager for the connection.
         *
        ...
        /**
         * Get the Schemas grammar used by the connection.
         *
        ...
        /**
         * Set the Schemas grammar used by the connection.
         *
    ...
    class Request {
         ...
         *
         * Only the URIs path component (no Schemas, host etc.) is relevant and must be given.
    ...
    class Schema {
        ...
        /**
         * Create a new table on the Schemas.
         *
         * @param string $table
         * @param \Closure $callback
         * @return void
        ...
        /**
         * Drop a table from the Schemas if it exists.
         *
         * @param string $table
         * @return void
         * @static
